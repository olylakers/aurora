 ...
 * 2013-6-12 下午3:04:13 
 */
public class AuroraNettyPushEventDecoder extends SimpleChannelUpstreamHandler {
	private final boolean unfold;
	private ConcurrentHashMap<Integer, ChannelBuffer> cumulation = new ConcurrentHashMap<Integer, ChannelBuffer>();

	public AuroraNettyPushEventDecoder() {
		this(false);
	}

	protected AuroraNettyPushEventDecoder(boolean unfold) {
		this.unfold = unfold;
	}
	...
	protected  Object decode(ChannelHandlerContext ctx, Channel channel, ChannelBuffer buffer) throws Exception{
		return ProtocolUtils.decodePushEvent(buffer, null);
	}
